...
// http://swagger.io/specification/#externaloptionsumentationObject
type openapiExternaloptionsumentationObject struct {
	Description string `json:"description,omitempty"`
	URL         string `json:"url,omitempty"`
}
...
type openapiSwaggerObject struct {
	...
	Externaloptionss        *openapiExternaloptionsumentationObject `json:"externaloptionss,omitempty"`
