...
import (
	...
	options "github.com/BlackCodes/micro-swagger/protoc-gen-micro-swagger/options"
...
type OpenAPImicroOption struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OpenAPImicroOption) Reset() {
	*x = OpenAPImicroOption{}
	if protoimpl.UnsafeEnabled {
...
func (x *OpenAPImicroOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenAPImicroOption) ProtoMessage() {}

func (x *OpenAPImicroOption) ProtoReflect() protoreflect.Message {
	mi := &file_internal_descriptor_openapiconfig_openapiconfig_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenAPImicroOption.ProtoReflect.Descriptor instead.
func (*OpenAPImicroOption) Descriptor() ([]byte, []int) {
	return file_internal_descriptor_openapiconfig_openapiconfig_proto_rawDescGZIP(), []int{4}
}

func (x *OpenAPImicroOption) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *OpenAPImicroOption) GetOption() *options.JSONSchema {
	if x != nil {
		return x.Option
	}
	return nil
...
type OpenAPIOptions struct {
	...
	Field   []*OpenAPImicroOption   `protobuf:"bytes,5,rep,name=field,proto3" json:"field,omitempty"`
}
...
func (x *OpenAPIOptions) GetField() []*OpenAPImicroOption {
	if x != nil {
		return x.Field
	}
	return nil
...
var file_internal_descriptor_openapiconfig_openapiconfig_proto_goTypes = []interface{}{
	...
	(*OpenAPImicroOption)(nil),   // 4: grpc.gateway.internal.descriptor.openapiconfig.OpenAPImicroOption
...
var file_internal_descriptor_openapiconfig_openapiconfig_proto_depIdxs = []int32{
	...
	11, // 4: grpc.gateway.internal.descriptor.openapiconfig.OpenAPImicroOption.option:type_name -> grpc.gateway.protoc_gen_openapiv2.options.JSONSchema
	...
	4,  // 9: grpc.gateway.internal.descriptor.openapiconfig.OpenAPIOptions.field:type_name -> grpc.gateway.internal.descriptor.openapiconfig.OpenAPImicroOption
...
func file_internal_descriptor_openapiconfig_openapiconfig_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_descriptor_openapiconfig_openapiconfig_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OpenAPImicroOption); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
